...
$accountantsor=$db->prepare("SELECT * FROM muhasebeci where accountant_mail=:mail");

$accountantsor->execute(array('mail' => $_SESSION['accountant_mail'] ));

$say=$accountantsor->rowCount();
$accountantcek=$accountantsor->fetch(PDO::FETCH_ASSOC);
...
<head>
  ...
  <title>İlteriş Yönetim | Muhasebe Paneli</title>
        ...
        <div class="left_col scroll-view">
          ...
          <div class="profile clearfix">
            ...
            <div class="profile_info">
              <span>Hoşgeldin</span>
              <h2><?php echo $accountantcek['accountant_ad']." ".$accountantcek['accountant_soyad'] ?></h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="">
            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
              <img src="https://cdn1.iconfinder.com/data/icons/technology-devices-2/100/Profile-512.png" alt=""><?php echo $accountantcek['accountant_ad']." ".$accountantcek['accountant_soyad'] ?>
