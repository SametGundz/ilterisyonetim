                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Apartmannın DB Adı<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="apartman_db"id="first-name" required="required" class="form-control col-md-7 col-xs-12"placeholder="Örneğin: Ateş Apartmanı => ates_apartmani">
                        </div>
                      </div>
